...
const products_tab = document.querySelector(".products_tab");
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function displayTickets() {
        let  tickets =  JSON.parse(localStorage.getItem('tickets')) || [];
        let table = '<table border="1"><thead><tr><th>First Name</th><th>Last Name</th><th>Phone Number</th><th>Ticket Type</th><th>From City</th><th>To City</th><th>Date</th></tr></thead><tbody>';
